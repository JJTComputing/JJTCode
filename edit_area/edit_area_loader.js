...
function EditAreaLoader(){
	...
	t.advanced_buttons = [
			...
			['new_document', 'document-new.png', 'new_document', false],
			['search', 'search.png', 'show_search', false],
			['go_to_line', 'go-next.png', 'go_to_line', true],
			...
			['load', 'document-open.png', 'load', false],
			['fullscreen', 'view-fullscreen.png', 'toggle_full_screen', false],
